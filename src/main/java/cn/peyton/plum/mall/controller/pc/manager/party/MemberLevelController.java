...
public class MemberLevelController extends RealizeController
        implements IController<Integer, MemberLevelParam> {
    ...
    public JSONResult<?> list(Query query) {
        ...
        return page(new MemberLevelParam(), new PageQuery(query.getPageNo(), ORDER_BY_FILED), memberLevelService, true);
    }
    ...
    public JSONResult<?> create(MemberLevelParam record) {
        ...
        return handle(record, _repeat, false, memberLevelService, TIP_MEMBER_LEVEL, CREATE);
    }
    ...
    public JSONResult<?> edit(MemberLevelParam record) {
        ...
        _repeat.setName(record.getName());
        return handle(record, _repeat, true, memberLevelService, TIP_MEMBER_LEVEL, UPDATE);
    }
    ...
    public JSONResult<?> delete(@NotBlank(message = "Id 不能为空;")
        ...
        return delete(id, memberLevelService, TIP_MEMBER_LEVEL);
    }
    ...
    public JSONResult<?> updateStatus(@NotBlank(message = "Id 不能为空;")
        ...
        return handle(_param, null, true, memberLevelService, TIP_MEMBER_LEVEL, STATUS, UPDATE);
    }
