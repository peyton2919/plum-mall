...
public interface SupplierInfoMapper {
	 ...
	 * @return 对象集合
	 */
	List<SupplierInfo> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<SupplierInfo> selectByObj(SupplierInfo record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(SupplierInfo record);
