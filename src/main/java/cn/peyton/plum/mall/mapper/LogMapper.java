...
public interface LogMapper {
	 ...
	 * @return 对象集合
	 */
	List<Log> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Log> selectByObj(Log record, @Param("page") PageQuery page);
