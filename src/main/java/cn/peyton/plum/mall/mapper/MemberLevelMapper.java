...
public interface MemberLevelMapper {
	 ...
	 * @return 对象集合
	 */
	List<MemberLevel> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<MemberLevel> selectByObj(MemberLevel record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(MemberLevel record);
