...
public interface InvoiceMapper {
	 ...
	 * @return 对象集合
	 */
	List<Invoice> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Invoice> selectByObj(Invoice record, @Param("page") PageQuery page);
