...
public interface JobMapper {
	 ...
	 * @return 对象集合
	 */
	List<Job> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Job> selectByObj(Job record, @Param("page") PageQuery page);
