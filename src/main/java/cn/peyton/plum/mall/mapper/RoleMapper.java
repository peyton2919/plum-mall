...
public interface RoleMapper {
	 ...
	 * @return 对象集合
	 */
	List<Role> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Role> selectByObj(Role record, @Param("page") PageQuery page);
