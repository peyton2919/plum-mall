...
public interface SupplierLogMapper {
	 ...
	 * @return 对象
	 */
	SupplierLog selectByPrimaryKey(Long id);
	 ...
	 * @return 对象集合
	 */
	List<SupplierLog> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<SupplierLog> selectByObj(SupplierLog record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(SupplierLog record);
