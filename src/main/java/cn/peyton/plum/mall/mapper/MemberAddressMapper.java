...
public interface MemberAddressMapper {
	 ...
	 * @return 对象集合
	 */
	List<MemberAddress> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<MemberAddress> selectByObj(MemberAddress record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(MemberAddress record);
