...
public interface ShopProductMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopProduct> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopProduct> selectByObj(ShopProduct record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(ShopProduct record);
