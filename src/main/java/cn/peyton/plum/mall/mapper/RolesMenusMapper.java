...
public interface RolesMenusMapper {
	 ...
	 * @return 对象集合
	 */
	List<RolesMenus> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<RolesMenus> selectByObj(RolesMenus record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(RolesMenus record);
