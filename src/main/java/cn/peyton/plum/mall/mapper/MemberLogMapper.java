...
public interface MemberLogMapper {
	 ...
	 * @return 对象集合
	 */
	List<MemberLog> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<MemberLog> selectByObj(MemberLog record, @Param("page") PageQuery page);
