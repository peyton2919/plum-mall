...
public interface UserLogMapper {
	 ...
	 * @return 对象集合
	 */
	List<UserLog> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<UserLog> selectByObj(UserLog record, @Param("page") PageQuery page);
