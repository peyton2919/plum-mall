...
public interface MaterialMapper {
	 ...
	 * @return 对象集合
	 */
	List<Material> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Material> selectByObj(Material record, @Param("page") PageQuery page);
