...
public interface ExpressMapper {
	 ...
	 * @return 对象集合
	 */
	List<Express> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Express> selectByObj(Express record, @Param("page") PageQuery page);
