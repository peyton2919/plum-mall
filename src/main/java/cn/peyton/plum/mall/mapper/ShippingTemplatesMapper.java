...
public interface ShippingTemplatesMapper {
	 ...
	 * @return 对象
	 */
	ShippingTemplates selectByPrimaryKey(Integer id);
	 ...
	 * @return 对象集合
	 */
	List<ShippingTemplates> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShippingTemplates> selectByObj(ShippingTemplates record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(ShippingTemplates record);
