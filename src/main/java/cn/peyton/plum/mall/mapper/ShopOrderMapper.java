...
public interface ShopOrderMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopOrder> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopOrder> selectByObj(ShopOrder record, @Param("page") PageQuery page);
