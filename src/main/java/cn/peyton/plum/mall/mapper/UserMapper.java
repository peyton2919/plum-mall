...
public interface UserMapper {
	 ...
	 * @return 对象集合
	 */
	List<User> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<User> selectByObj(User record, @Param("page") PageQuery page);
