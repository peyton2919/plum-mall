...
public interface MenuMapper {
	 ...
	 * @return 对象集合
	 */
	List<Menu> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Menu> selectByObj(Menu record, @Param("page") PageQuery page);
