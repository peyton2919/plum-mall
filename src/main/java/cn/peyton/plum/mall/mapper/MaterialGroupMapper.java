...
public interface MaterialGroupMapper {
	 ...
	 * @return 对象集合
	 */
	List<MaterialGroup> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<MaterialGroup> selectByObj(MaterialGroup record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(MaterialGroup record);
