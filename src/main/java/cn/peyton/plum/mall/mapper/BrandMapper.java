...
public interface BrandMapper extends IBaseMapper<Long, Brand> {
    ...
    // */
    //Integer updateSelective(Brand record);
    //
    ///**
    // * <h4>根据 主键 删除 对象</h4>
    // * @param id 主键
    ...
    // * @return 对象集合
    // */
    //List<Brand> selectByLiekAndObj(@Param("record") Brand record, @Param("page") PageQuery page);
    //
    //
    ///**
    // * <h4>根据对象 分页查找</h4>
    ...
    // * @return 对象集合
    // */
    //List<Brand> selectByObj(@Param("record") Brand record,@Param("page") PageQuery page);
    //
    //
    ///**
    ...
    // * @return 总条数
    // */
    //Integer countByLike(@Param("record") Brand record);
    //
    //
    ///**
    // * <h4>查找全部数量</h4>
    ...
    // * @return 总条数
    // */
    //Integer count(@Param("record") Brand record);
