...
public interface BrandMapper {
	 ...
	 * @return 对象集合
	 */
	List<Brand> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Brand> selectByObj(Brand record, @Param("page") PageQuery page);
