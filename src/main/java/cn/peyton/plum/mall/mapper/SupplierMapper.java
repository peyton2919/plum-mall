...
public interface SupplierMapper {
	 ...
	 * @return 对象集合
	 */
	List<Supplier> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Supplier> selectByObj(Supplier record, @Param("page") PageQuery page);
