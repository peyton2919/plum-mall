...
public interface ShopCouponMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopCoupon> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopCoupon> selectByObj(ShopCoupon record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(ShopCoupon record);
