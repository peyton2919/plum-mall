...
public interface DictMapper {
	 ...
	 * @return 对象集合
	 */
	List<Dict> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Dict> selectByObj(Dict record, @Param("page") PageQuery page);
