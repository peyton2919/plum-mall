...
public interface MemberMapper {
	 ...
	 * @return 对象集合
	 */
	List<Member> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Member> selectByObj(Member record, @Param("page") PageQuery page);
