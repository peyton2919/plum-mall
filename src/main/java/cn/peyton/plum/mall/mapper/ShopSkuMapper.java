...
public interface ShopSkuMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopSku> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopSku> selectByObj(ShopSku record, @Param("page") PageQuery page);
