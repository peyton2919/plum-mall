...
public interface ShopCartMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopCart> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopCart> selectByObj(ShopCart record, @Param("page") PageQuery page);
