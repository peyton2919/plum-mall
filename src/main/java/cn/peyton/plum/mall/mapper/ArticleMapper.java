...
public interface ArticleMapper {
	 ...
	 * @return 对象集合
	 */
	List<Article> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Article> selectByObj(Article record, @Param("page") PageQuery page);
