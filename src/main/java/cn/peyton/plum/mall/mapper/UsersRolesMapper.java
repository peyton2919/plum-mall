...
public interface UsersRolesMapper {
	 ...
	 * @return 对象集合
	 */
	List<UsersRoles> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<UsersRoles> selectByObj(UsersRoles record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(UsersRoles record);
