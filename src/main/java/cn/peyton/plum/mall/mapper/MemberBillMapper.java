...
public interface MemberBillMapper {
	 ...
	 * @return 对象集合
	 */
	List<MemberBill> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<MemberBill> selectByObj(MemberBill record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(MemberBill record);
