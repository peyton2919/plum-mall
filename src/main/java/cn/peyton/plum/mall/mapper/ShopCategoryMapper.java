...
public interface ShopCategoryMapper {
	 ...
	 * @return 对象集合
	 */
	List<ShopCategory> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<ShopCategory> selectByObj(ShopCategory record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(ShopCategory record);
