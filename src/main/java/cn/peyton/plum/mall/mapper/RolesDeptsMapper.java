...
public interface RolesDeptsMapper {
	 ...
	 * @return 对象
	 */
	RolesDepts selectByPrimaryKey(Long id);
	 ...
	 * @return 对象集合
	 */
	List<RolesDepts> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<RolesDepts> selectByObj(RolesDepts record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(RolesDepts record);
