...
public interface DeptMapper {
	 ...
	 * @return 对象集合
	 */
	List<Dept> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Dept> selectByObj(Dept record, @Param("page") PageQuery page);
