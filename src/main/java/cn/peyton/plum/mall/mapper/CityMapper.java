...
public interface CityMapper {
	 ...
	 * @return 对象集合
	 */
	List<City> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<City> selectByObj(City record, @Param("page") PageQuery page);
