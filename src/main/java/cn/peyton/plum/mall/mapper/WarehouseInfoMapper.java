...
public interface WarehouseInfoMapper {
	 ...
	 * @return 对象集合
	 */
	List<WarehouseInfo> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<WarehouseInfo> selectByObj(WarehouseInfo record, @Param("page") PageQuery page);
	 ...
	 * @return 大于0 表示 重名
	 */
	int isRename(WarehouseInfo record);
