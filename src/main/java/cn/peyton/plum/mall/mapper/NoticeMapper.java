...
public interface NoticeMapper {
	 ...
	 * @return 对象集合
	 */
	List<Notice> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Notice> selectByObj(Notice record, @Param("page") PageQuery page);
