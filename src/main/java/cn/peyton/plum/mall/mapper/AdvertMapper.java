...
public interface AdvertMapper {
	 ...
	 * @return 对象集合
	 */
	List<Advert> selectByAllOrKeyword(@Param("keyword") String keyword, @Param("page") PageQuery page);
	 ...
	 * @return 对象集合
	 */
	List<Advert> selectByObj(Advert record, @Param("page") PageQuery page);
