...
public class ShopProductSkuDetailParam implements Serializable {
     ...
     * 一级返佣
     */
    @DecimalMin(value = 0,message = "一级返佣价格不能小于0元")
    private BigDecimal brokerage;
    /**
     * 二级返佣
     */
    @DecimalMin(value = 0,message = "二级返佣价格不能小于0元")
    private BigDecimal brokerageTwo;
    /**
     * 拼团价格
     */
    @DecimalMin(value = 0,message = "拼团价格不能小于0元")
     ...
     * 砍价价格
     */
    @DecimalMin(value = 0.01,message = "砍价价格不能小于0.01元")
     ...
     * <pre>
     * 	 转换字段如下:
     * 	 [id,productId,skus,stock,sales,cover,uniqueCode,barCode,price,vipPrice,otPrice,costPrice,weight,volume,
     * 	 brokerage,brokerageTwo,pinkPrice,pinkStock,seckillPrice,seckillStock,integral,warehouseId,warehouseExplain]
     * </pre>
     */
    public ShopProductSkuDetail convert() {
        ...
        shopProductSkuDetail.setMinStock(minStock);
     ...
     * <pre>
     * 	 转换字段如下:
     * 	 [id,productId,skus,stock,sales,cover,uniqueCode,barCode,price,vipPrice,otPrice,costPrice,weight,
     * 	 volume,brokerage,brokerageTwo,pinkPrice,pinkStock,seckillPrice,seckillStock,integral,warehouseId,warehouseExplain]
     * </pre>
     */
    public ShopProductSkuDetailParam compat(ShopProductSkuDetail shopProductSkuDetail) {
        ...
        this.setMinStock(shopProductSkuDetail.getMinStock());
