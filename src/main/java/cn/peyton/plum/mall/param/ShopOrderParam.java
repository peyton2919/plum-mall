...
public class ShopOrderParam implements Serializable {
	 ...
	 * <pre>
	 * 	 转换字段如下:
	 * 	 [id,orderId,extendOrderId,memberId,memberRealName,memberPhone,memberAddress,cartId,freightPrice,totalNum,totalPrice,totalPostage,payPrice,payPostage,deductionPrice,couponId,couponPrice,paid,payTime,payType,createTime,updateTime,status,refundStatus,refundReasonWapImg,refundReasonWapExplain,refundReasonTime,refundReasonWap,refundReason,refundPrice,deliverySn,deliveryName,deliveryType,deliveryId,gainIntegral,useIntegral,payIntegral,backIntegral,mark,isDel,uniqueCdoe,remark,combinationId,pinkId,cost,seckillId,bargainId,verifyCode,shopId,shippingType]
	 * </pre>
	 */
	public ShopOrder convert(){
		...
		shopOrder.setExtendOrderId(extendOrderId);
		shopOrder.setMemberId(memberId);
		shopOrder.setMemberRealName(memberRealName);
		...
		shopOrder.setRefundReasonWapImg(refundReasonWapImg);
		shopOrder.setRefundReasonWapExplain(refundReasonWapExplain);
		shopOrder.setRefundReasonTime(refundReasonTime);
		shopOrder.setRefundReasonWap(refundReasonWap);
		...
		shopOrder.setMark(mark);
		shopOrder.setIsDel(isDel);
		shopOrder.setUniqueCdoe(uniqueCdoe);
		shopOrder.setRemark(remark);
		shopOrder.setCombinationId(combinationId);
		shopOrder.setPinkId(pinkId);
		shopOrder.setCost(cost);
	...
	public ShopOrderParam compat(ShopOrder shopOrder){ 
		...
		this.setOrderId(shopOrder.getOrderId());
		this.setExtendOrderId(shopOrder.getExtendOrderId());
		this.setMemberId(shopOrder.getMemberId());
		this.setMemberRealName(shopOrder.getMemberRealName());
		this.setMemberPhone(shopOrder.getMemberPhone());
		this.setMemberAddress(shopOrder.getMemberAddress());
		...
		this.setRefundReasonWapImg(shopOrder.getRefundReasonWapImg());
		this.setRefundReasonWapExplain(shopOrder.getRefundReasonWapExplain());
		this.setRefundReasonTime(shopOrder.getRefundReasonTime());
		this.setRefundReasonWap(shopOrder.getRefundReasonWap());
		this.setRefundReason(shopOrder.getRefundReason());
		this.setRefundPrice(shopOrder.getRefundPrice());
		...
		this.setMark(shopOrder.getMark());
		this.setIsDel(shopOrder.getIsDel());
		this.setUniqueCdoe(shopOrder.getUniqueCdoe());
		this.setRemark(shopOrder.getRemark());
		this.setCombinationId(shopOrder.getCombinationId());
		this.setPinkId(shopOrder.getPinkId());
		this.setCost(shopOrder.getCost());
