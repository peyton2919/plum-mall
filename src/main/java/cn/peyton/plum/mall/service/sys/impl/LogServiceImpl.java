 ...
 */
@Service("logService")
public class LogServiceImpl extends RealizeService<Long, Log, LogParam> implements LogService {
    @Resource
    private LogMapper logMapper;

    @Override
    public BaseConvertBo<Log, LogParam> bo() {
        return new LogBo();
    }

    @Override
    public IBaseMapper<Long, Log> mapper() {
        return logMapper;
    }
