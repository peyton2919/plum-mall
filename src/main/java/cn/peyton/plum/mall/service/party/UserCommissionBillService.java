...
/**
 * <h3> 用户分佣账单{用户ID(包含: 会员Id、供应商Id、员工Id等,配合share_type一起使用)} Service 接口</h3>
 * <pre>
 ...
 * </pre>
 */
public interface UserCommissionBillService extends IBaseService<Long, UserCommissionBill, UserCommissionBillParam> {
