...
public class ShopProductRelationServiceImpl extends AbstractRealizeService<Long, ShopProductRelation, ShopProductRelationParam> implements ShopProductRelationService {
    @Resource
