...
public class ShopProductReplyImgServiceImpl extends AbstractRealizeService<Long, ShopProductReplyImg, ShopProductReplyImgParam> implements ShopProductReplyImgService {
    @Resource
