...
public class ShopCouponMemberServiceImpl extends AbstractAppRealizeService<Long, ShopCouponMember, ShopCouponMemberParam> implements ShopCouponMemberService {
    @Resource
