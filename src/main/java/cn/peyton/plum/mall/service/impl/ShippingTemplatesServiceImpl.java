...
public class ShippingTemplatesServiceImpl extends AbstractAppRealizeService<Integer, ShippingTemplates, ShippingTemplatesParam> implements ShippingTemplatesService {
    @Resource
