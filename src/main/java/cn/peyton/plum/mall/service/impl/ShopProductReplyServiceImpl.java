...
public class ShopProductReplyServiceImpl extends AbstractAppRealizeService<Long, ShopProductReply, ShopProductReplyParam> implements ShopProductReplyService {
    @Resource
