...
public final class Regulation implements Serializable {
    ...
    public final static String REGEX_DATE = "((([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})" +
            "(\\s*|[-\\/])(((0[13578]|1[02])(\\s*|[-\\/])(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)" +
            "(\\s*|[-\\/])(0[1-9]|[12][0-9]|30))|(02(\\s*|[-\\/])(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})" +
    ...
    public final static String REGEX_DATETIME = "^((([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})" +
            "(\\s*|[-\\/])(((0[13578]|1[02])(\\s*|[-\\/])(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)(\\s*|[-\\/])(0[1-9]|[12][0-9]|30))|" +
            "(02(\\s*|[-\\/])(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))" +
            "(\\s*|[-\\/])02(\\s*|[-\\/])29))(|(\\s*|[-\\/])(([0-1]?[0-9]|2[0-3])(\\s*|[-\\/]|[:])([0-5][0-9])(\\s*|[-\\/]|[:])([0-5][0-9])))$";
    /**
     * <pre>
     *     <h4>邮箱 验证</h4>
     *     只能是字母与数字 组成
