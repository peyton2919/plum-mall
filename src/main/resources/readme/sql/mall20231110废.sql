...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '广告信息';
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '品牌信息';
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '会员';
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '会员地址';
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '会员等级';
...
(
    ...
    `cover`         varchar(256)  NOT NULL COMMENT '商品图片',
...
(
    ...
    `product_sku_id` bigint(20) NULL COMMENT '商品ID',
    PRIMARY KEY (`id`)
...
(
    ...
    `reply_comment`          varchar(512) NOT NULL COMMENT '评论内容',
